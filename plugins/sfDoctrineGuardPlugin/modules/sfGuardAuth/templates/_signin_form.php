...
<div class="row">
    <form class="floating-labels col-md-12" action="<?php echo url_for('@sf_guard_signin') ?>" method="post">
        ...
        <div style="background: #FAFAFA; border-radius:22px;" class="form-group col-md-12 <?php echo $form['username']->hasError() ? 'has-error' : '' ?>">
        ...
        <div style="background: #FAFAFA; border-radius:22px;" class="form-group col-md-12 <?php echo $form['password']->hasError() ? 'has-error' : '' ?>">
        ...
        <div class="form-group  col-md-12">
            ...
            <input style="background: #594fd4; border-radius:22px;"
                   class="btn btn-info btn-lg btn-block text-uppercase btn-rounded" type="submit"
                   value="<?php echo __('Sign in', null, 'sf_guard') ?>"/>
        </div>
