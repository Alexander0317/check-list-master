...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <!-- Logo -->
            <!-- ============================================================== -->
            <div class="navbar-header" style="background: #234C63;">
                <a class="navbar-brand" href="index.html" >
                   <h1> <p style="color:#FFFFFF">TiQal</p></h1></span> </a>
            </div>
                ...
                <div class="navbar-collapse" >
                    ...
                    <ul class="navbar-nav my-lg-0" >
                        ...
                        <li class="nav-item dropdown" >
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/images/users/dos.jpg" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY" >
                                <ul class="dropdown-user" >
                                    <li>
                                        <div class="dw-user-box" style="background: #96C937;">
                                            <div class="u-img" ><img src="/images/users/dos.jpg" alt="user" ></div>
                                            <div class="u-text">
                                                <h4>User</h4>
                                                <p class="text-muted"> <h6>ejemplo@gmail.com</h6></p><a style="background: #234C63;" href="<?php echo url_for('/logout')?>" class="btn btn-rounded btn-danger btn-sm">Cerrar sesión</a></div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
        ...
        <!-- ============================================================== -->
        <aside class="left-sidebar" style="background: #234C63;" >
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar" style="background: #234C63;" >
                <!-- Sidebar navigation-->
                <nav class="sidebar-nav" style="background: #234C63;">
                    <ul id="sidebarnav">
                        <?php if ($sf_user->hasCredential('admin')): ?>
                        <li>
                              <a class="waves-effect waves-dark" href="<?php echo url_for('template/index') ?>" aria-expanded="false"><i class="fa fa-list-alt"></i><span class="hide-menu">Inicio</span></a>
                          </li>  
                        <li>
                          ...
                          <li>
                              <a class="waves-effect waves-dark" href="<?php echo url_for('template/inicio') ?>" aria-expanded="false"><i class="fa fa-list-alt"></i><span class="hide-menu">Plantillas</span></a>
                          </li>
                          <li>
                              <a class="waves-effect waves-dark" href="<?php echo url_for('template/newCriterion') ?>" aria-expanded="false"><i class="fa fa-tasks"></i><span class="hide-menu">Agregar Criterio</span></a>
                          </li>
                        <?php endif; ?>
                        ...
                        <?php if ($sf_user->hasCredential('admin') || $sf_user->hasCredential('staff') || $sf_user->hasCredential('guest')): ?>
                          ...
                          <li>
                              <a class="waves-effect waves-dark" href="<?php echo url_for('template/inicio') ?>" aria-expanded="false"><i class="fa fa-bar-chart-o"></i><span class="hide-menu">Reportes</span></a>
                          </li>
                        <?php endif; ?>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <!-- ============================================================== -->
            <footer class="footer" style="background: #96C937;" > <h2>TiQal / Universidad Antonio José Camacho </h2></footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
